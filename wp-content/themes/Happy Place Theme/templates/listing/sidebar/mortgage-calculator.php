...
$property_tax = $listing_data['details']['property_tax'] ?? 0;
$hoa_fees = $listing_data['details']['hoa_fees'] ?? 0;

// Get mortgage data from ACF fields
    ...
    <div class="widget-content">
        <form class="mortgage-form" id="mortgage-calculator">
            ...
            <div class="calculator-actions">
                <button type="button" class="btn btn-primary btn-block" id="get-pre-approved">
                    <i class="fas fa-check-circle"></i>
                    Get Pre-Approved
                </button>
                <button type="button" class="btn btn-outline btn-block" id="contact-lender">
