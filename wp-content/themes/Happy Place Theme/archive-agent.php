            ...
            <div class="hph-split-view">
                ...
                <aside class="hph-sidebar" role="complementary">
                    ...
                    <div class="hph-sidebar-content">
                        <form id="agent-filter-form" class="hph-filters-form">
                            ...
                            <!-- Clear Filters -->
                            <div class="hph-filter-section">
                                <button type="button" class="action-btn action-btn--outline action-btn--block hph-clear-filters">
                ...
                <main class="hph-main-content">
                    ...
                    <div class="hph-results-content view-<?php echo esc_attr($view_mode); ?>">
                        <?php if (have_posts()) : ?>
                            <!-- Grid View -->
                            <div class="auto-grid" style="<?php echo $view_mode !== 'grid' ? 'display: none;' : ''; ?>">
                                    ...
                                    <article id="post-<?php the_ID(); ?>" <?php post_class('hph-agent-card'); ?>>
                                        ...
                                        <div class="hph-agent-content">
                                            ...
                                            <div class="hph-agent-actions">
                                                <a href="<?php the_permalink(); ?>" class="action-btn action-btn--primary action-btn--sm">
                                                    View Profile
                                                </a>
                                                <button type="button" class="action-btn action-btn--outline action-btn--sm hph-contact-agent-modal" data-agent-id="<?php echo esc_attr(get_the_ID()); ?>" data-agent-name="<?php echo esc_attr(get_the_title()); ?>">
                                                    Contact
                                                </button>
                                            </div>
                                        </div>
                        ...
                        <?php else : ?>
                            ...
                            <div class="hph-no-results">
                                ...
                                <button type="button" class="action-btn action-btn--primary hph-clear-filters">
                                    Clear All Filters
                                </button>
                            </div>
                        <?php endif; ?>
