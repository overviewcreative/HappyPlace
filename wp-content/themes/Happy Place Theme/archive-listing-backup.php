...
<div class="hph-listings-archive">
    ...
    <?php else : ?>
        ...
        <div class="hph-listings-layout search-results-grid">
            <!-- Sidebar Filters -->
            <aside class="hph-listings-sidebar grid-area-filters">
            ...
            <!-- Main Content -->
            <main class="hph-listings-main grid-area-results">
                <!-- Results Header -->
                        ...
                        <div class="hph-no-results">
                            <div class="hph-no-results-content">
                                ...
                                <div class="hph-no-results-actions">
                                    <a href="<?php echo get_post_type_archive_link('listing'); ?>" class="action-btn action-btn--primary">
                                        <?php esc_html_e('View All Properties', 'happy-place'); ?>
                                    </a>
                                    <button type="button" class="action-btn action-btn--secondary" onclick="document.getElementById('listingFilters').reset();">
