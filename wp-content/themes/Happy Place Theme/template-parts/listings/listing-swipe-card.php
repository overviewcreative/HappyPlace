                ...
                ?>
                    <div class="hph-open-house-item">
                        <div class="hph-open-house-date">
                            <div class="hph-open-house-day">
                                <?php echo date('D', strtotime($oh_date)); ?>
                            </div>
                            <div class="hph-open-house-month-day">
                        ...
                        <div class="hph-open-house-details">
                            ...
                            <?php if ($oh_agent) : ?>
                                <div class="hph-open-house-agent">
                                    <?php esc_html_e('Hosted by', 'happy-place'); ?> <?php echo esc_html(get_the_title($oh_agent)); ?>
                                </div>
                            <?php endif; ?>
                            <?php if ($oh_instructions) : ?>
                                <div class="hph-open-house-instructions">
                                    <?php echo esc_html($oh_instructions); ?>
                                </div>
                            <?php endif; ?>
                        </div>
                        <div class="hph-open-house-action">
                            <button class="hph-open-house-rsvp-btn" data-open-house-id="<?php echo esc_attr($open_house->ID); ?>">
