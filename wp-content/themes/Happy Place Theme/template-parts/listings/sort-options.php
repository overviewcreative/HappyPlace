...
<div class="hph-results-header grid grid-2 md:auto-grid-sm gap-4 align-items-center justify-content-between">
    ...
    <div class="hph-sort-wrapper auto-grid-xs gap-2 align-items-center">
