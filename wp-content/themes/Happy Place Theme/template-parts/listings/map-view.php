...
<div class="hph-map-container hph-relative hph-h-screen">
        ...
        ?>
            <div class="hph-map-card hph-p-4 hph-border-b hph-border-gray-200 hover:hph-bg-gray-50 hph-transition-colors" 
                ...
                <div class="hph-map-card__content">
                    ...
                    <div class="auto-grid-xs gap-4 align-items-center">
                        <?php if ($beds) : ?>
                            <span class="auto-grid-xs gap-1 align-items-center">
                    ...
                    <a href="<?php the_permalink(); ?>" class="action-btn action-btn--text hph-mt-3">
    ...
    <div id="map-controls" class="hph-map-controls hph-absolute hph-top-4 hph-left-4 hph-space-y-2">
        <button class="action-btn action-btn--white hph-shadow-lg" id="map-center">
            <i class="fas fa-crosshairs"></i>
        </button>
        <button class="action-btn action-btn--white hph-shadow-lg" id="map-zoom-in">
            <i class="fas fa-plus"></i>
        </button>
        <button class="action-btn action-btn--white hph-shadow-lg" id="map-zoom-out">
