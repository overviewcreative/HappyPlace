...
<div class="hph-open-houses-section">
    ...
    <div class="hph-section-header hph-d-flex hph-justify-between hph-items-center hph-mb-6">
        ...
        <div class="hph-section-actions">
            <button class="action-btn action-btn--primary" data-modal="schedule-open-house">
                ...
                ?>
                    <div class="hph-event-card" data-event-id="<?php echo esc_attr($event['ID']); ?>">
                        ...
                        <div class="hph-event-actions">
                            <button class="action-btn action-btn--outline action-btn--sm" 
                                    data-action="edit" 
                            ...
                            <div class="hph-dropdown">
                                <button class="action-btn action-btn--secondary action-btn--sm hph-dropdown-toggle">
    ...
    <div class="hph-events-view hph-events-view--calendar <?php echo $view_mode !== 'calendar' ? 'hph-d-none' : ''; ?>" data-view="calendar">
        <div class="hph-calendar-widget">
            <div class="hph-calendar-header">
                ...
                <button class="action-btn action-btn--outline action-btn--sm" data-action="today">
                ...
                ?>
                    <div class="hph-past-event-item">
                        ...
                        <div class="hph-past-event-actions">
                            <button class="action-btn action-btn--outline action-btn--sm" data-action="view-report">
...
<div class="hph-modal hph-modal--schedule" id="schedule-open-house-modal">
    ...
    <div class="hph-modal__content">
        <div class="hph-modal__header">
            ...
            <button class="hph-modal__close" data-dismiss="modal" aria-label="Close Modal">
        ...
        <form method="POST" action="" class="hph-open-house-form">
            ...
            <div class="hph-modal__footer">
                ...
                <button type="submit" name="hph_create_open_house" class="action-btn action-btn--primary">
                    <i class="fas fa-calendar-plus"></i>
                    <?php esc_html_e('Schedule Open House', 'happy-place'); ?>
                </button>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    modalTriggers.forEach(trigger => {
        trigger.addEventListener('click', function(e) {
            e.preventDefault();
            scheduleModal.classList.add('hph-modal--active');
    ...
    modalCloses.forEach(close => {
        close.addEventListener('click', function() {
            scheduleModal.classList.remove('hph-modal--active');
    ...
    scheduleModal.addEventListener('click', function(e) {
        if (e.target === this || e.target.classList.contains('hph-modal__overlay')) {
            this.classList.remove('hph-modal--active');
            document.body.classList.remove('hph-modal-open');
        }
    });
    ...
    document.addEventListener('click', function(e) {
        ...
        if (action) {
            ...
            switch (actionType) {
                case 'edit':
                    // Open edit modal functionality would go here
                    break;
                case 'share':
                    // Open share modal
                    if (navigator.share) {
