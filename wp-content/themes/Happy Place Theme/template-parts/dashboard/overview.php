...
<div class="hph-overview-section">
    ...
    <div class="hph-dashboard-content">
        ...
        <div class="hph-dashboard-widget">
            ...
            <div class="hph-dashboard-widget-footer">
                <a href="<?php echo esc_url(add_query_arg('section', 'activity')); ?>" class="action-btn action-btn--outline action-btn--sm">
            ...
            <div class="hph-dashboard-widget">
                ...
                <div class="hph-dashboard-widget-content">
                    <div class="hph-quick-actions">
                        <button type="button" class="hph-quick-action" onclick="HphDashboard.showListingForm()">
    ...
    <div class="hph-dashboard-widget">
                        ...
                        <div class="hph-listing-content">
                            ...
                            <div class="hph-listing-actions">
                                ...
                                <button type="button" class="hph-listing-action" 
                                        onclick="HphDashboard.showListingForm(<?php echo intval($listing_id); ?>)"
        ...
        <div class="hph-dashboard-widget-footer">
            <a href="<?php echo esc_url(add_query_arg('section', 'listings')); ?>" class="action-btn action-btn--outline">
